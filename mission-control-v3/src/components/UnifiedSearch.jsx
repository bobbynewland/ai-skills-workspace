...
const UnifiedSearch = ({ onNavigate }) => {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-12 text-white placeholder-white/40 focus:outline-none focus:border-gold/50 text-lg"
          autoFocus
        />
        {query && (
          <button
      ...
      <button
        ...
        className="w-full py-3 bg-gold text-black font-bold rounded-xl hover:bg-gold/80 disabled:opacity-50"
      >
